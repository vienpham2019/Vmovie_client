...
const Home = () => {
  ...
  const isAdmin = roles.some((role) => RoleEnum.ADMIN === role);
    ...
    <div>
      <nav className="flex flex-wrap justify-between items-center text-white py-3 px-[2rem] bg-gray-800">
        ...
        {!token ? (
          ...
          <div className="flex justify-around items-center gap-4 pt-2 pb-5 px-2">
            <div className="flex gap-[0.5rem]">
              ...
              <div className="grid">
                ...
                {isAdmin && (
                  <small
                    className="text-[0.8rem] cursor-pointer underline text-cyan-500"
      ...
      <footer className="bg-gray-800">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="flex flex-wrap justify-around items-center">
            ...
            <div className="flex flex-wrap gap-5 text-[0.9rem]">
              <div>
          ...
          <div className="flex flex-wrap items-center justify-between px-[3rem]">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <p className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
